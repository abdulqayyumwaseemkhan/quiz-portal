    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <main className="flex-1 ml-64 p-8">
        <header className="flex justify-between items-center mb-10">
          <div>
            <h1 className="text-3xl font-black text-gray-900">Manage Assignments</h1>
            <p className="text-gray-500">Create assignments and collect zip submissions</p>
          </div>
          <button 
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
              ...
              {assignments.map((assignment) => (
                <tr key={assignment._id} className="hover:bg-gray-50/50 transition-colors group">
                  <td className="px-8 py-5">
                    <p className="font-bold text-gray-800 text-lg">{assignment.title}</p>
                    <p className="text-sm text-gray-500 line-clamp-1">{assignment.description || 'No description'}</p>
                  </td>
          ...
          {assignments.length === 0 && !loading && (
            <div className="p-20 text-center">
              ...
              <p className="text-gray-400 font-semibold text-xl uppercase tracking-widest">No assignments found</p>
            </div>
          )}
        </div>
      </main>
