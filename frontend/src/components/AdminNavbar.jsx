...
const AdminNavbar = () => {
  ...
  return (
    <div className="w-64 glass h-screen shadow-2xl fixed left-0 top-0 flex flex-col z-50 border-r border-white/10">
      <div className="p-6 border-b border-[#31572c] text-center">
          <h2 className="text-2xl font-bold text-[#ecf39e] tracking-tight">BanoQabil</h2>
          <p className="text-[10px] text-[#8aa97a] font-semibold uppercase tracking-[0.2em] mt-1">Admin Portal</p>
      </div>
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-3 px-4 py-4 rounded-xl transition-all duration-200 ${
                isActive 
                  ? 'bg-[#ecf39e] text-[#31572c] font-bold' 
                  : 'text-slate-400 hover:bg-[#1e2e1b] hover:text-[#ecf39e]'
              }`}
            >
              <Icon size={20} />
      ...
      <div className="p-4 border-t border-[#31572c]">
        <button
